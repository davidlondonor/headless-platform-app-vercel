...
async function del(url, options) {
  const blobApiResponse = await _undici.fetch.call(void 0, getApiUrl("/delete"), {
    method: "POST",
    headers: {
      ...getApiVersionHeader(),
...
exports.BlobAccessError = BlobAccessError; exports.BlobError = BlobError; exports.BlobUnknownError = BlobUnknownError; exports.del = del; exports.generateClientTokenFromReadWriteToken = generateClientTokenFromReadWriteToken; exports.getPayloadFromClientToken = getPayloadFromClientToken; exports.handleBlobUpload = handleBlobUpload; exports.head = head; exports.list = list; exports.put = put; exports.verifyCallbackSignature = verifyCallbackSignature;
